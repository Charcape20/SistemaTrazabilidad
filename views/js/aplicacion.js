            ...
            formatters: {
                "commands": function (column, row) {
                    return "<div class=\"row\">" +
                        "<a class=\"btn btn-default btn-info\"href=\"../?c=Libro&a=VerLibro&id=" +
                        +row.id + "\"><i class=\"fa fa-eye\" aria-hidden=\"true\"></i>&nbsp;" +
                        "</a>" +
                        "<a class=\"btn btn-default btn-danger\"href=\"../?c=Libro&a=EditarLibro&id=" +
                        +row.id + "\"><i class=\"fa fa-pencil\" aria-hidden=\"true\"></i>&nbsp;" +
                        "</a>"
                        + "</div>"
                },
