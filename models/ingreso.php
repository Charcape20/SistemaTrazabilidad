...
class IngresoModels{
    ...
    public function ingresoModelos($datosModel,$tabla){
        $con=new Conexion();
		$stmt = $con->conectar()->prepare("SELECT id_user, usuario, password, id_tipo_user,intentos FROM $tabla WHERE usuario = :usuario");
